  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "20px 0" }}>
      ...
      <div className="scan-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 30 }}>
        <div>
          <h1 style={{ margin: 0, fontFamily: "'Lora',serif", fontSize: 28, color: C.text }}>USB barcode scanner</h1>
          <p style={{ margin: "4px 0 0", color: C.textLight, fontSize: 14 }}>
            Plug in a handheld scanner (keyboard wedge) or type an ISBN and press Enter. For phone camera scanning, use{" "}
            <strong style={{ color: C.text }}>Book Catalogue → Add Book</strong>.
          </p>
        </div>
      </div>
      ...
      {status === "idle" || status === "scanning" ? (
        <div
          style={{
            background: C.cardBg,
            border: `2px dashed ${status === "scanning" ? C.primary : C.cardBorder}`,
            borderRadius: 20,
            padding: 40,
            textAlign: "center",
            boxShadow: C.shadow,
        ...
        >
          {status === "scanning" ? (
            ...
            >
              ...
              <p style={{ color: C.textMid, fontSize: 13, marginBottom: 30 }}>
                Click anywhere on this page to keep focus in the field so wedge scanners always type here.
              </p>
              ...
              <div style={{ maxWidth: 400, margin: "0 auto", position: "relative" }}>
                <input
                  ...
                  style={{
                    ...
                    color: C.text,
                    outline: "none",
                    boxShadow: `0 4px 15px ${C.primary}20`,
                  }}
                />
              </div>
            </form>
        ...
        <div style={{ background: C.greenBg, border: `1.5px solid ${C.green}40`, borderRadius: 20, padding: 30, boxShadow: C.shadow }}>
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 24, border: `1px solid ${C.green}20`, display: "flex", gap: 24, flexWrap: "wrap" }}>
            <div
              style={{
                width: 80,
                height: 80,
            ...
            <div style={{ flex: 1, minWidth: 200 }}>
              ...
              <div style={{ color: C.textMid, fontSize: 14, marginBottom: 12 }}>
                by {bookData.author} · ISBN: {bookData.isbn}
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, minWidth: 160 }}>
              <Btn onClick={handleAddStock} variant="success" style={{ padding: "12px 16px", flex: 1 }}>
                +1 to Stock
              </Btn>
              <Btn onClick={resetScanner} variant="ghost" style={{ padding: "12px 16px", border: `1px solid ${C.inputBorder}` }}>
                Scan Another
              </Btn>
            </div>
          </div>
        ...
        <div style={{ background: C.cardBg, border: `1.5px solid ${C.cardBorder}`, borderRadius: 20, padding: 30, boxShadow: C.shadow }}>
          <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 20, flexWrap: "wrap" }}>
            ...
            {form.source && (
              <span
                style={{
                  background: form.source === "Open Library" ? C.greenBg : C.primaryBg,
                  color: form.source === "Open Library" ? C.green : C.primaryDark,
                  border: `1px solid ${form.source === "Open Library" ? C.green : C.primary}30`,
                  borderRadius: 20,
                  padding: "2px 10px",
                  fontSize: 11,
                  fontWeight: 700,
            ...
            >
              {form.thumbnail ? (
                <img
                  ...
                  style={{ width: 70, height: 100, objectFit: "cover", borderRadius: 8, boxShadow: "0 4px 12px rgba(0,0,0,0.15)", flexShrink: 0 }}
                />
              ) : (
                <div
                  style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ color: C.text, fontWeight: 800, fontSize: 17, fontFamily: "'Lora',serif", marginBottom: 4, lineHeight: 1.3 }}>
                  {form.title || "Unknown Title"}
                </div>
          ...
          <div
            ...
            style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, background: C.pageBg, padding: 24, borderRadius: 16, border: `1px solid ${C.cardBorder}` }}
          >
            ...
            <FInput
              ...
              onChange={(e: any) =>
                setForm((f: any) => ({
                  ...f,
                  total: parseInt(e.target.value, 10) || 1,
                  available: parseInt(e.target.value, 10) || 1,
                }))
              }
            />
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "flex-end", marginTop: 24 }}>
            <Btn variant="ghost" onClick={resetScanner}>
              Cancel Scan
            </Btn>
            <Btn onClick={() => void saveNewBook()}>Save to Library</Btn>
          </div>
        </div>
      ) : null}
    </div>
